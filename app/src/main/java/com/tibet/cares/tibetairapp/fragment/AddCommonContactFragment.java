 ...
 */
public class AddCommonContactFragment extends BaseFragment {
    ...
    public int getLayoutId() {
        return R.layout.fragment_add_common_contact;
    }

    @Override
    protected void initView() {
        commonTopTv.setText("新增联系人");
    ...
    @OnClick(R.id.btn_confirm_add_commom_contact)
    public void onClick() {
